    ...
    <>
      ...
      <section className="relative min-h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 lg:px-8 pb-16 w-full">
          <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-4">Qui suis-je ?</p>
      ...
      <section className="bg-[#FDFAF6] py-24">
        <div className="max-w-6xl mx-auto px-5 lg:px-8 grid md:grid-cols-2 gap-16 items-start">
          <div>
            <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-6">Mon histoire</p>
          ...
          <div className="bg-[#1A130C] rounded-2xl p-8 md:p-10">
            <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-6">Ma philosophie</p>
      ...
      <section className="bg-[#F3EBE1] py-20">
        <div className="max-w-6xl mx-auto px-5 lg:px-8 grid md:grid-cols-2 gap-10">
          <div className="bg-white rounded-2xl p-8">
            <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-6">Horaires d'appels</p>
          ...
          <div className="bg-white rounded-2xl p-8">
            <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-6">Laboratoire</p>
      ...
      <section className="bg-[#FDFAF6] py-20">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-6">Information</p>
          ...
          <div className="grid sm:grid-cols-2 gap-3">
            {siteConfig.allergens.list.map((a, i) => (
              <div key={i} className="bg-white border border-[#F3EBE1] rounded-xl p-4 flex gap-3 items-start">
                <span className="w-2 h-2 bg-[#E8899B] rounded-full mt-1.5 flex-shrink-0" />
                <div>
      ...
      <section className="bg-white py-20">
        <div className="max-w-3xl mx-auto px-5 lg:px-8">
          <p className="text-xs uppercase tracking-[0.25em] text-[#E8899B] mb-6 text-center">FAQ</p>
            ...
            {siteConfig.faq.questions.map((item, i) => (
              <div key={i}>
                ...
                >
                  ...
                  <ChevronDown className={`w-5 h-5 text-[#E8899B] flex-shrink-0 transition-transform ${openFaq === i ? 'rotate-180' : ''}`} />
                </button>
                {openFaq === i && (
