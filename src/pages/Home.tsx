...
<h1 className="font-display text-[2.75rem] sm:text-6xl md:text-8xl lg:text-[7.5rem] font-bold text-white leading-[0.9] md:leading-[0.88] mb-8">
            Ô'Gourmandiz<br />
            <em>d'Aurore</em>
          </h1>
        ...
        <div className="max-w-6xl mx-auto px-5 lg:px-8">
          <div className="text-center mb-16">
            ...
            <div className="inline-flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-5 py-2.5">
              ...
              <span className="text-white/60 text-sm">{siteConfig.reviews.count} avis Google</span>
            </div>
          </div>
          ...
          <div className="text-center mt-10">
            ...
            >
              ...
              Voir les {siteConfig.reviews.count} avis sur Google
            </a>
          </div>
        </div>
      </section>
